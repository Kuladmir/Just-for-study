...
#SBATCH --nodelist=k216
#SBATCH --output=none
#SBATCH --error=none
#SBATCH --gres=gpu:1
#SBATCH --mail-type=END
#SBATCH --mail-user=kuladmir@163.com

export PATH=/pubhome/soft/gromacs/2023.2/threadMPI_OpenMP/bin:$PATH

function cleanup () {
    test -d $tmpdir && \cp -rf $tmpdir/$my_base $my_dir && rm  -rf $tmpdir
    test -d $my_dir/$my_base && scp -r $my_dir/$my_base jqzang02@k143.hn.org:/pubhome/jqzang02/gromacs/result_test
    }
...
gmx grompp -f em.mdp -r solv_ions.gro -c solv_ions.gro -p topol.top -o em.tpr -maxwarn 2 >> MD_S_conf1.out 2>&1
gmx mdrun -ntmpi 1 -v -deffnm em >> MD_S_conf1.out 2>&1
gmx grompp -f nvt.mdp -c em.gro -r em.gro -p topol.top -o nvt.tpr -maxwarn 2 >> MD_S_conf1.out 2>&1
gmx mdrun -ntmpi 1 -deffnm nvt >> MD_S_conf1.out 2>&1
gmx grompp -f npt.mdp -c nvt.gro -t nvt.cpt -r nvt.gro -p topol.top -o npt.tpr -maxwarn 2 >> MD_S_conf1.out 2>&1
gmx mdrun -ntmpi 1 -deffnm npt >> MD_S_conf1.out 2>&1
gmx grompp -f md1.mdp -c npt.gro -t npt.cpt -r npt.gro -p topol.top -o md_restraint.tpr -maxwarn 2 >> MD_S_conf1.out 2>&1
gmx mdrun -ntmpi 1 -deffnm md_restraint  >> MD_S_conf1.out 2>&1
gmx grompp -f md.mdp -c md_restraint.gro -t md_restraint.cpt -p topol.top -o md_ptoye.tpr -maxwarn 2 >> MD_S_conf1.out 2>&1
gmx mdrun -ntmpi 1 -deffnm md_ptoye >> MD_S_conf1.out 2>&1
